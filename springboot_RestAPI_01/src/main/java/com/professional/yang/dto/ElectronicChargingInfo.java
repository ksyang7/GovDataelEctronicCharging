...
@Data
public class ElectronicChargingInfo {
		...
		public ElectronicChargingInfo(String id, String name, String addr, String addr_detail, String longitude, String latitude, String usage_time) {
			this.charging_id = id;
